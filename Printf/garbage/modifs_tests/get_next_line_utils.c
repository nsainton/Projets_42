...
/*   Updated: 2022/11/15 23:53:12 by nsainton         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

static void	ft_flush(char buff[BUFFER_SIZE], size_t index)
{
	size_t	i;
...
static int	ft_fill_line(char *line, char buff[BUFFER_SIZE], \
size_t *end_of_line)
{
	size_t	line_index;
	size_t	buffer_index;
	...
	buffer_index = 0;
	new_line = 0;
	while (buff[buffer_index] && buffer_index < BUFFER_SIZE && ! new_line)
	{
...
char	*ft_get_line(char *line, char buff[BUFFER_SIZE], int fd, \
size_t *end_of_line)
{
	ssize_t	n_read;
